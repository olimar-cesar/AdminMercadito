<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListProveedor.aspx.cs" Inherits="Admin.ListProveedor" %>
...
<html>
<head>
    <title>| Sistema Admin | Listado Proveedor|</title>
...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#ffffff">
    ...
    <tr>
	  ...
	  <td height="20" colspan="3" valign="top"  >&nbsp; <h2> Listado de Proveedor</h2></td>
    </tr>
    <tr>
      ...
      <!--Contenido aqui-->
          ...
          <asp:GridView ID="gridClientes" runat="server" CssClass="subtitulo" EmptyDataText="No existen Registros" 
...
<HeaderStyle Width="100px"></HeaderStyle>
                   ...
                   <asp:TemplateField HeaderText="Acciones" HeaderStyle-Width="100px">
                      <ItemTemplate>
                          <asp:ImageButton runat="server" ID="btnEditar" AlternateText="Editar Proveedor" ToolTip="Editar Proveedor" CssClass="cBotones" ImageUrl="~/Images/edit.png" CommandName="EditarProveedor" CommandArgument='<%# Eval("Id") %>'/>
                          <asp:ImageButton runat="server" ID="btnEliminar" AlternateText="Eliminar Proveedor" ToolTip="Eliminar Proveedor" CssClass="cBotones" ImageUrl="~/Images/eliminar.gif"  CommandName="EliminarProveedor" CommandArgument='<%# Eval("Id") %>'/>
                      </ItemTemplate>
