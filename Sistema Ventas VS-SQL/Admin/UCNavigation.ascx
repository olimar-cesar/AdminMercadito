...
<table width="200" border="0" cellspacing="1" cellpadding="0">
    ...
    <tr id="divLogin" runat="server">
      ...
      <td height="20" bgcolor="#225628"><asp:HyperLink CssClass="izq" ID="lnkCRM" NavigateUrl="Login.aspx" runat="server">Login</asp:HyperLink></td>
      <td height="20">&nbsp;</td>
    </tr>
    ...
    <tr id="divlblUsuarios" >
      <td height="20">&nbsp;</td>
      <td width="4" bgcolor="#d2d2c6">&nbsp;</td>
      <td height="20" bgcolor="#225628" class="titleBlanco">
        <ASP:Label id="lblUsuarios" runat="server">Usuarios:</ASP:Label></td>
      <td height="20">&nbsp;</td>
    </tr>
    <tr id="divlnkAddUsuarios" >
      <td height="20">&nbsp;</td>
      <td width="4" bgcolor="37703e">&nbsp;</td>
      <td height="20" bgcolor="#225628">&nbsp;&nbsp;&nbsp;&nbsp;
        <ASP:HyperLink id="lnkAddUsuarios" runat="server" cssclass="izq2" navigateurl="EditUsuario.aspx">Nuevo Usuario</ASP:HyperLink></td>
      <td height="20">&nbsp;</td>
    </tr>
    <tr id="divlnkListUsuarios" >
      <td height="20">&nbsp;</td>
      <td width="4" bgcolor="37703e">&nbsp;</td>
      <td height="20" bgcolor="#225628">&nbsp;&nbsp;&nbsp;&nbsp;
        <ASP:HyperLink id="lnkListUsuarios" runat="server" cssclass="izq2" navigateurl="ListUsuario.aspx">Listar Usuarios</ASP:HyperLink></td>
      <td height="20">&nbsp;</td>
    </tr>
    ...
    <tr style="background=blue" runat="server" id="trTipoSitio" visible="false">
      <td width="10">&nbsp;</td>
      <td width="4">&nbsp;</td>
      <td>TESTING...</td>
      <td width="10">&nbsp;</td>
  ...
  <script language="javascript" type="text/javascript">
      function ocultarEnlaces(b) {
          ...
          document.getElementById('divlblUsuarios').style.display = cad;
          document.getElementById('divlnkAddUsuarios').style.display = cad;
          document.getElementById('divlnkListUsuarios').style.display = cad;
