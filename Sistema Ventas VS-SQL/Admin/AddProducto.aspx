...
<html>
<head>
    <title>| El Mercadito | Alta de Productos|</title>
...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#ffffff">
    <tr>
      <td colspan="4"><img src="Images/elmercadito.png" width="1000" height="159"></td>
    </tr>
    <tr>
      ...
      <asp:GridView ID="gridProductos" runat="server" CssClass="subtitulo" EmptyDataText="No existen Registros" 
              ...
              <Columns>
                  ...
                  <asp:TemplateField HeaderText="Descripcion" HeaderStyle-Width="150px">
                   ...
                   <asp:TemplateField HeaderText="Categoria" HeaderStyle-Width="100px">
                      <ItemTemplate>
