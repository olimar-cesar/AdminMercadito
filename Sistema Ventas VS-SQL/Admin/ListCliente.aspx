...
<html>
<head>
    <title>| El Mercadito | Listado Clientes|</title>
                  ...
                  <asp:TemplateField HeaderText="Email" HeaderStyle-Width="100px">
                   ...
                   <asp:TemplateField HeaderText="Acciones" HeaderStyle-Width="100px">
                      <ItemTemplate>
                          ...
                          <asp:ImageButton runat="server" ID="btnEliminar" AlternateText="Eliminar Cliente" ToolTip="Eliminar Cliente" CssClass="cBotones" ImageUrl="~/Images/eliminar.gif"  CommandName="EliminarCliente" CommandArgument='<%# Eval("Id") %>'/>
                      </ItemTemplate>
                  </asp:TemplateField>
              </Columns>
          </asp:GridView>
