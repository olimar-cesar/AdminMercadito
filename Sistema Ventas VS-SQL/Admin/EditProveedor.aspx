<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditProveedor.aspx.cs" Inherits="Admin.EditProveedor" %>
...
<html>
<head>
    <title>| Sistema Admin | Proveedores</title>
...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#ffffff">
    ...
    <tr>
	  ...
	  <td height="20" colspan="3" valign="top"  >&nbsp; <h2> Alta de Proveedor</h2></td>
    </tr>
    <tr>
      ...
      <td width="770" valign="top" colspan="3">
          ...
          <table>
              <tr>
                  <td>
                      <asp:Label runat="server" Text="Id Proveedor" ID="labelProveedorId"></asp:Label>
                  </td>
                  <td>
              ...
              <tr>
                  ...
                  <td>
                      ...
                      <ASP:RequiredFieldValidator id="rfvValidarNombre" runat="server" errormessage=" * El nombre es obligatorio" width="132px" controltovalidate="txtNombre" display="Dynamic" style="margin-left: 22px"></ASP:RequiredFieldValidator>
                  </td>
              </tr>
              <tr>
                  <td>
