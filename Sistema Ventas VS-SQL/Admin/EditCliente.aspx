...
<html>
<head>
    <title>| El Mercadito | Clientes</title>
          ...
          <table>
              ...
              <tr>
                  ...
                  <td>
                      ...
                      <ASP:RequiredFieldValidator id="rfvValidarDomicilio" runat="server" errormessage="El domicilio es obligatorio" width="132px" controltovalidate="txtDomicilio" display="Dynamic"></ASP:RequiredFieldValidator>
                  </td>
              </tr>
              <tr>
                  <td>
                  ...
                  <td>
                      <ew:numericbox runat="server" id="txtTelefono" decimalplaces="0" CausesValidation="True" DollarSign="S" MaxLength="9" RealNumber="False"></ew:numericbox>
                      <ASP:RequiredFieldValidator id="rfvValidarTelefono" runat="server" errormessage="El telefono es obligatorio" width="132px" controltovalidate="txtTelefono" display="Dynamic"></ASP:RequiredFieldValidator>
                  </td>
              </tr>
              ...
              <tr>
                  ...
                  <td>
                      ...
                      <ASP:RequiredFieldValidator id="rfvValidarEmail" runat="server" errormessage="El email es obligatorio" width="132px" controltovalidate="txtEmail" display="Dynamic"></ASP:RequiredFieldValidator>
                  </td>
              </tr>
