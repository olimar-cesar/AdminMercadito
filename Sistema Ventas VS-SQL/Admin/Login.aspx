...
<tr>
            ...
            <form id="Form1" runat="server">
                ...
                <td width="202" height="20" align="left" valign="middle">
                          <ASP:RequiredFieldValidator id="chkUserID" runat="server" errormessage="Debe ingresar un usuario" width="132px" controltovalidate="txtUserID" display="Dynamic"></ASP:RequiredFieldValidator></td>
                        </tr>
                        <tr>
                ...
                <td width="202" height="20" align="left" valign="middle">
                          <ASP:RequiredFieldValidator id="chkPassword" runat="server" errormessage="Debe ingresar una contraseña" controltovalidate="txtPassword" display="Dynamic"></ASP:RequiredFieldValidator></td>
                        </tr>
